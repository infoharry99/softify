...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionsByModule = [
            ...
            'HR' => [
                ['name' => 'View HR Candidates', 'slug' => 'hr.view', 'description' => 'View candidate/student directory'],
                ['name' => 'Create Candidates', 'slug' => 'hr.create', 'description' => 'Add new candidates/students'],
                ['name' => 'Edit Candidates', 'slug' => 'hr.edit', 'description' => 'Edit candidate records and upload resumes'],
                ['name' => 'Delete Candidates', 'slug' => 'hr.delete', 'description' => 'Remove candidate records'],
                ['name' => 'Export HR Data', 'slug' => 'hr.export', 'description' => 'Export candidates dataset'],
            ],
            'Sales' => [
        ...
        $defaultRoles = [
            ...
            [
                'name' => 'HR',
                'slug' => 'hr',
                'description' => 'Human resources and candidate management',
                'status' => 'active',
                'permissions' => [
